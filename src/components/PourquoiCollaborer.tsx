  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-16 xl:grid-cols-2 items-start">
          {/* LEFT */}
          <div className="order-2 xl:order-1">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold leading-tight">
              <span className="text-[#F26418]">Pourquoi Collaborer avec MTC&nbsp;?</span>
            </h2>

            <h3 className="mt-3 sm:mt-4 md:mt-6 text-sm sm:text-base md:text-lg lg:text-xl font-semibold">
              Une vision tournée vers l'avenir des infrastructures
            </h3>

            <p className="mt-2 sm:mt-3 md:mt-4 text-xs sm:text-sm md:text-base lg:text-lg text-muted-foreground leading-relaxed">
            ...
            <div className="relative mt-4 sm:mt-6 md:mt-8 rounded-lg sm:rounded-xl lg:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl ring-1 ring-black/5">
          ...
          <div className="relative order-1 xl:order-2">
            ...
            <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-lg sm:shadow-xl ring-1 ring-black/5">
             ...
             <h3 className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg lg:text-xl font-semibold">
               <span className="text-[#F26418] font-extrabold text-2xl sm:text-3xl md:text-4xl lg:text-5xl">+14 </span>
               ans d'expérience dans le domaine
             </h3>
             <p className="mt-2 sm:mt-3 md:mt-4 text-xs sm:text-sm md:text-base lg:text-lg text-muted-foreground leading-relaxed py-4 md:py-6 lg:py-8">
